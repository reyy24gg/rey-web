...
export default function Faq() {
    ...
    return (
        <section
            id="faq"
            className="py-20 2xl:py-32 relative overflow-hidden"
        >
            <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="relative hidden md:flex justify-start">
                    ...
                    <motion.div
                        ...
                        className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-600/30 blur-[120px] rounded-full"
                    />
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 1.5 }}
                        className="absolute top-1/3 left-0 w-[350px] h-[2px] bg-gradient-to-r from-white/70 to-transparent blur-sm"
                    />
