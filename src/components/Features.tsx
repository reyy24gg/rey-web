  ...
  return (
    <section id="features" className="py-20 2xl:py-32">
      <div className="max-w-6xl mx-auto px-4">
        <Title
          title="Services"
          heading="Your Gaming Solution"
          description="We provide everything you need to dominate the game and unlock exclusive content. Explore our offerings and enhance your gaming journey with us."
        />
